...
INSERT INTO nguoidung (hoTen, email, matkhau, sdt, diachi, vaitro, trangthai) VALUES
('Nguyen Van A', 'nguyenvana@example.com', 'password123', '0123456789', '123 ABC Street', 'hocvien', 'active'),
('Tran Thi B', 'tranthib@example.com', 'password123', '0987654321', '456 DEF Street', 'giaovien', 'active'),
('Le Van C', 'levanc@example.com', 'password123', '0123987654', '789 GHI Street', 'giaovu', 'active');
