        ...
        <Row gutter={[16, 16]} className="ml-2 mt-8">
          <Col span={24}>
            <Form.Item label="Chọn Tag">
              ...
              >
                <Select.Option value="[Part 3] Câu hỏi về chủ đề, mục đích">[Part 3] Câu hỏi về chủ đề, mục đích</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi về danh tính người nói">[Part 3] Câu hỏi về danh tính người nói</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi về chi tiết cuộc hội thoại">[Part 3] Câu hỏi về chi tiết cuộc hội thoại</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi về hành động tương lai">[Part 3] Câu hỏi về hành động tương lai</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi kết hợp bảng biểu">[Part 3] Câu hỏi kết hợp bảng biểu</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi về hàm ý câu nói">[Part 3] Câu hỏi về hàm ý câu nói</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Company - General Office Work">[Part 3] Chủ đề: Company - General Office Work</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Company - Personnel">[Part 3] Chủ đề: Company - Personnel</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Company - Event, Project">[Part 3] Chủ đề: Company - Event, Project</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Company - Facility">[Part 3] Chủ đề: Company - Facility</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Shopping, Service">[Part 3] Chủ đề: Shopping, Service</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Order, delivery">[Part 3] Chủ đề: Order, delivery</Select.Option>
                <Select.Option value="[Part 3] Chủ đề: Transportation">[Part 3] Chủ đề: Transportation</Select.Option>
                <Select.Option value="[Part 3] Câu hỏi về yêu cầu, gợi ý">[Part 3] Câu hỏi về yêu cầu, gợi ý</Select.Option>
              </Select>
            </Form.Item>
          </Col>
        </Row>
