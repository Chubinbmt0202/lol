...
export default function Story() {
  const [items, setItems] = useState([
    ...
    { id_ID: '2', content: 'Câu hỏi 2', tag: ' Câu hỏi về danh tính, địa điểm' },
    { id_ID: '3', content: 'Câu hỏi 3', tag: ' Câu hỏi về chi tiết' },
    ...
    { id_ID: '7', content: 'Câu hỏi 7', tag: ' Dạng bài: Telephone message - Tin nhắn thoại' },
    { id_ID: '8', content: 'Câu hỏi 8', tag: ' Dạng bài: News report, Broadcast - Bản tin' },
    { id_ID: '9', content: 'Câu hỏi 9', tag: ' Dạng bài: Talk - Bài phát biểu, diễn văn' },
    {
      id_ID: '10',
      content: 'Câu hỏi 10',
      tag: ' Dạng bài: Excerpt from a meeting - Trích dẫn từ buổi họp',
    },
  ]);
